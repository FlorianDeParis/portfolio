...
<html>
	...
	<body>
			...
			<div class="presentation">
				...
				<div class="titre_corps">
					...
					<div class="bio">Développeur Web / Graphiste Amateur<br>
						Etudiant en alternance, passionné des technologies du web, de design ainsi que du high-tech.</div>
				</div>
			</div>
			<div class="arrow">
		...
		<div class="conteneur">
			<div class="parcours">
				<font class="titre_cursus">Cursus Scolaire</font>
				<ul class="cursus">
					<li>
					...
					<li>
						...
						<div class="etude">
							<font class="brevet">Baccalauréat STI - Sciences Techniques de l'Industrie</font><br>
